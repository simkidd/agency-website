  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Vanguardds is a forward-thinking digital agency that transforms ideas into exceptional digital experiences. Since 2012, we've been pushing the boundaries of what's possible."
      />
      <AboutStory />
      <AboutValues />
      <TeamGrid />
